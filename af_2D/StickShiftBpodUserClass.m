classdef StickShiftBpodUserClass < handle

    properties (Constant=true)
        % serverIPAddressAsString = '127.0.0.1';                % bias listens on this ip
        serverIPAddressAsString = '10.123.1.163';                % bias listens on this ip
    ...
    methods
        function self = StickShiftBpodUserClass()
